...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
      <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-indigo-100/30 dark:bg-indigo-900/10 rounded-full blur-3xl hidden md:block"></div>
      <div className="absolute bottom-20 left-0 w-[400px] h-[400px] bg-purple-100/20 dark:bg-purple-900/10 rounded-full blur-3xl hidden md:block"></div>
      ...
      <section className="py-10 md:py-24 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-14">
            <div className="flex-shrink-0 animate-fade-in-up w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-72 lg:h-72">
            ...
            <div className="flex-1 text-center md:text-left animate-fade-in-up animation-delay-200">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-4 md:mb-5 leading-relaxed">
          ...
          <div className="mt-12 md:mt-20">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-center mb-8 md:mb-12 tracking-tight text-gray-900 dark:text-gray-100">
              What I Do
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              <div className="group relative bg-white dark:bg-gray-800/80 rounded-2xl p-5 sm:p-6 md:p-7 shadow-sm dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700/50 hover:border-indigo-100 dark:hover:border-indigo-900/30 transition-all duration-400 hover:-translate-y-1 hover:shadow-xl animate-fade-in-up animation-delay-100 overflow-hidden">
                ...
                <h3 className="text-base md:text-lg lg:text-xl font-bold mb-2 md:mb-3 text-gray-900 dark:text-gray-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Web Development</h3>
              ...
              <div className="group relative bg-white dark:bg-gray-800/80 rounded-2xl p-5 sm:p-6 md:p-7 shadow-sm dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700/50 hover:border-indigo-100 dark:hover:border-indigo-900/30 transition-all duration-400 hover:-translate-y-1 hover:shadow-xl animate-fade-in-up animation-delay-200 overflow-hidden">
                ...
                <h3 className="text-base md:text-lg lg:text-xl font-bold mb-2 md:mb-3 text-gray-900 dark:text-gray-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">DevOps & Automation</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
              ...
              <div className="group relative bg-white dark:bg-gray-800/80 rounded-2xl p-5 sm:p-6 md:p-7 shadow-sm dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700/50 hover:border-indigo-100 dark:hover:border-indigo-900/30 transition-all duration-400 hover:-translate-y-1 hover:shadow-xl animate-fade-in-up animation-delay-300 overflow-hidden">
                ...
                <h3 className="text-base md:text-lg lg:text-xl font-bold mb-2 md:mb-3 text-gray-900 dark:text-gray-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Roaming Adminstrator</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
