  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="relative">
        <div className="absolute h-px bg-gradient-to-r from-transparent via-indigo-200 dark:via-indigo-800 to-transparent"></div>
      </div>
      <Skills />
      <section className="py-12 md:py-24 bg-gray-50 dark:bg-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mt-10 md:mt-16 animate-fade-in-up animation-delay-500">
            <a
              href="/projects"
